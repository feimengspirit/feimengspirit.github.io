...
##总结
果粉实在强大，Apple手机的占有率超高，其中5s以上设备(支持Touch ID)的数量也相当可观。目前很多App都增加了对Touch ID的支持。其中的翘楚当属老牌应用1password。

苹果本身也通过退出Apple Pay强势进入支付领域。Apple Pay借助指纹支付+NFC的方案。
<img src="/images/blog/touchid/applepay.png" width="50%">
Apple Pay的收银台使用的是浸入式的设计，收银台上可以看到商品的详情，也可以切换付款渠道。轻松一按手指，即可完成付款。实乃剁手党的福音!
